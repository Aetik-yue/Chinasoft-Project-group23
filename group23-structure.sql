...
) ENGINE=InnoDB AUTO_INCREMENT=641752 DEFAULT CHARSET=utf8mb4 COMMENT='湿度历史数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14486 DEFAULT CHARSET=utf8mb4 COMMENT='鹦鹉行为识别记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COMMENT='宠物饲养记账记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8mb4 COMMENT='宠物媒体记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COMMENT='宠物病历记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pet_profile` (
  ...
  KEY `idx_device_id` (`device_id`),
  KEY `idx_cage_id` (`cage_id`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='Pet profile table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COMMENT='Pet weight history table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=45373 DEFAULT CHARSET=utf8mb4 COMMENT='烟雾浓度历史数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_user` (
  ...
  KEY `idx_role` (`role`),
  KEY `idx_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='智慧烟感用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temperature_data` (
  ...
  KEY `idx_device_time` (`device_id`,`record_time`),
  KEY `idx_record_time` (`record_time`)
) ENGINE=InnoDB AUTO_INCREMENT=671997 DEFAULT CHARSET=utf8mb4 COMMENT='温度历史数据表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COMMENT='用户偏好表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-07-13 12:41:48
