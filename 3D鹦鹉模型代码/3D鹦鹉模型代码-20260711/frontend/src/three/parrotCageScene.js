...
export function createParrotCageScene(scene) {
  ...
  ;[0, 1, 2, 3].forEach((index) => {
    cylinderBetween(root, framePoints[index], framePoints[index + 4], 0.07, materials.frame).castShadow = false
  })
  ;[[4, 5], [6, 7], [4, 6], [5, 7], [0, 1], [2, 3]].forEach(([a, b]) => {
    cylinderBetween(root, framePoints[a], framePoints[b], 0.07, materials.frame).castShadow = false
  })
