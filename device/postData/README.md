...
1. 在 Paho 中连接 `tcp://47.108.58.107:1883`，订阅 `group23-s-to-h`，QoS 选择 1。
2. 先保存当前状态：
...
| 环境变量 | 默认值 |
| --- | --- |
| `MYSQL_URL` | `jdbc:mysql://47.108.58.107:3306/dream28...` |
| `MYSQL_USERNAME` / `MYSQL_PASSWORD` | README 中的远端数据库账号 |
